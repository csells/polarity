...
mkdir -p build
"$ARM_CC" -DPOLARITY_ADVANCE -mcpu=arm7tdmi -marm -O2 -ffreestanding -fno-builtin -Wall -Wextra -Isrc -Isrc/gba -nostdlib -Wl,-T,src/gba/link.ld,-Map,build/polarity-gba.map -o build/polarity.elf src/gba/start.s src/gba/main.c src/gba/audio.c src/gba/runtime.c src/engine.c src/gba/generated/levels.c src/city.c src/story.c src/gba/generated/assets.c src/gba/generated/music.s -lgcc
